...
export const furniture: Furniture[] = [
  ...
  { id: 'pc-carlos',       type: 'monitor_dual', x: 4,  y: 2,  direction: 2 },
  { id: 'mug-carlos',      type: 'mug',          x: 3,  y: 3,  color: '#EF4444' },

  { id: 'desk-marcos',     type: 'desk',         x: 4,  y: 6,  direction: 2, color: '#06B6D4' },
  { id: 'chair-marcos',    type: 'chair',        x: 5,  y: 6,  direction: 6, color: '#06B6D4' },
  { id: 'pc-marcos',       type: 'monitor_dual', x: 4,  y: 5,  direction: 2 },
  { id: 'mug-marcos',      type: 'mug',          x: 3,  y: 6,  color: '#06B6D4' },

  { id: 'desk-sophia',     type: 'desk',         x: 4,  y: 9,  direction: 2, color: '#8B5CF6' },
  { id: 'chair-sophia',    type: 'chair',        x: 5,  y: 9,  direction: 6, color: '#8B5CF6' },
  { id: 'pc-sophia',       type: 'monitor_dual', x: 4,  y: 8,  direction: 2 },
  { id: 'mug-sophia',      type: 'mug',          x: 3,  y: 9,  color: '#8B5CF6' },

  { id: 'desk-andre',      type: 'desk',         x: 4,  y: 12, direction: 2, color: '#3B82F6' },
  { id: 'chair-andre',     type: 'chair',        x: 5,  y: 12, direction: 6, color: '#3B82F6' },
  { id: 'pc-andre',        type: 'monitor_dual', x: 4,  y: 11, direction: 2 },
  { id: 'mug-andre',       type: 'mug',          x: 3,  y: 12, color: '#3B82F6' },
  ...
  { id: 'locker-L1',       type: 'locker',       x: 2,  y: 5  },
  { id: 'locker-L2',       type: 'locker',       x: 2,  y: 11 },
  { id: 'ac-L',            type: 'ac_unit',      x: 3,  y: 1  },
  ...
  { id: 'pc-diego',        type: 'monitor_dual', x: 20, y: 2,  direction: 6 },
  { id: 'mug-diego',       type: 'mug',          x: 21, y: 3,  color: '#10B981' },

  { id: 'desk-raquel',     type: 'desk',         x: 20, y: 6,  direction: 6, color: '#F59E0B' },
  { id: 'chair-raquel',    type: 'chair',        x: 19, y: 6,  direction: 2, color: '#F59E0B' },
  { id: 'pc-raquel',       type: 'monitor_dual', x: 20, y: 5,  direction: 6 },
  { id: 'mug-raquel',      type: 'mug',          x: 21, y: 6,  color: '#F59E0B' },

  { id: 'desk-helena',     type: 'desk',         x: 20, y: 9,  direction: 6, color: '#EC4899' },
  { id: 'chair-helena',    type: 'chair',        x: 19, y: 9,  direction: 2, color: '#EC4899' },
  { id: 'pc-helena',       type: 'monitor_dual', x: 20, y: 8,  direction: 6 },
  { id: 'mug-helena',      type: 'mug',          x: 21, y: 9,  color: '#EC4899' },

  { id: 'desk-victor',     type: 'desk',         x: 20, y: 12, direction: 6, color: '#F97316' },
  { id: 'chair-victor',    type: 'chair',        x: 19, y: 12, direction: 2, color: '#F97316' },
  { id: 'pc-victor',       type: 'monitor_dual', x: 20, y: 11, direction: 6 },
  { id: 'mug-victor',      type: 'mug',          x: 21, y: 12, color: '#F97316' },
  ...
  { id: 'locker-R1',       type: 'locker',       x: 22, y: 5  },
  { id: 'locker-R2',       type: 'locker',       x: 22, y: 11 },
  { id: 'ac-R',            type: 'ac_unit',      x: 21, y: 1  },

  // ─── PAREDES DE VIDRO — divisórias entre alas e corredor central ─────────────
  ...
  { id: 'glass-L4',        type: 'glass_wall',   x: 7,  y: 12, direction: 2 },
  { id: 'glass-R1',        type: 'glass_wall',   x: 17, y: 3,  direction: 6 },
  { id: 'glass-R2',        type: 'glass_wall',   x: 17, y: 6,  direction: 6 },
  { id: 'glass-R3',        type: 'glass_wall',   x: 17, y: 9,  direction: 6 },
  { id: 'glass-R4',        type: 'glass_wall',   x: 17, y: 12, direction: 6 },
  ...
  { id: 'board-tv',        type: 'tv_screen',    x: 12, y: 5,  label: 'PORTA SCORE' },
  { id: 'board-rug',       type: 'rug',          x: 12, y: 8,  color: '#1D4ED8' },
  { id: 'lamp-meeting-L',  type: 'lamp',         x: 9,  y: 5  },
  { id: 'lamp-meeting-R',  type: 'lamp',         x: 15, y: 5  },
  { id: 'mug-meeting-1',   type: 'mug',          x: 11, y: 7,  color: '#94A3B8' },
  { id: 'mug-meeting-2',   type: 'mug',          x: 13, y: 7,  color: '#94A3B8' },
  { id: 'sign-boardroom',  type: 'sign',         x: 12, y: 3,  label: 'BOARD ROOM' },

  // ─── RECEPÇÃO ────────────────────────────────────────────────────────────────
  { id: 'rec-rug',         type: 'rug',          x: 5,  y: 17, color: '#475569' },
  { id: 'rec-desk',        type: 'desk',         x: 5,  y: 18, direction: 4, color: '#94A3B8' },
  { id: 'rec-chair',       type: 'chair',        x: 5,  y: 19, direction: 0, color: '#94A3B8' },
  { id: 'rec-pc',          type: 'computer',     x: 5,  y: 17, direction: 4 },
  ...
  { id: 'rec-mug-1',       type: 'mug',          x: 5,  y: 20, color: '#F1F5F9' },
  { id: 'rec-cabinet',     type: 'cabinet',      x: 2,  y: 22, color: '#334155' },
  { id: 'rec-sign',        type: 'sign',         x: 5,  y: 16, label: 'SENIOR SCOUT' },
  { id: 'rec-tv',          type: 'tv_screen',    x: 8,  y: 17, label: 'WAR ROOM' },

  // ─── COPA ────────────────────────────────────────────────────────────────────
  { id: 'copa-fridge',         type: 'fridge',         x: 20, y: 17 },
  { id: 'copa-coffee-machine', type: 'coffee_machine', x: 21, y: 17 },
  { id: 'copa-microwave',      type: 'microwave',      x: 22, y: 17 },
  ...
  { id: 'copa-mug-1',          type: 'mug',            x: 19, y: 18, color: '#F59E0B' },
  { id: 'copa-mug-2',          type: 'mug',            x: 21, y: 19, color: '#EF4444' },
  { id: 'copa-mug-3',          type: 'mug',            x: 20, y: 21, color: '#8B5CF6' },
  { id: 'copa-plant',          type: 'plant',          x: 22, y: 20 },
  { id: 'copa-lamp',           type: 'lamp',           x: 22, y: 18 },
  { id: 'copa-trash',          type: 'trash',          x: 19, y: 20 },
  { id: 'copa-sign',           type: 'sign',           x: 20, y: 16, label: 'COPA' },
  ...
  { id: 'lounge-pool',     type: 'pool_table',   x: 15, y: 22 },
  { id: 'lounge-lamp-1',   type: 'lamp',         x: 17, y: 21 },
  { id: 'lounge-lamp-2',   type: 'lamp',         x: 21, y: 21 },
  { id: 'lounge-plant-1',  type: 'plant',        x: 17, y: 23 },
  { id: 'lounge-plant-2',  type: 'plant',        x: 21, y: 24 },
  { id: 'lounge-mug-1',    type: 'mug',          x: 19, y: 22, color: '#F1F5F9' },
  { id: 'lounge-tv',       type: 'tv_screen',    x: 16, y: 21, label: 'SCOUT 360' },
  { id: 'lounge-sign',     type: 'sign',         x: 19, y: 21, label: 'LOUNGE' },
